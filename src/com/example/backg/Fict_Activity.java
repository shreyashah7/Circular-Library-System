...
public class Fict_Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.fict_activity);
		
		DataBaseHandlerFict db = new DataBaseHandlerFict();
		...
		* */
		...
		// db.addContact(new Contact("BestFriendsForever", imageInByte,"Jennifer Weiner","1"));
		...
		adapter = new ContactImageAdapter(this, R.layout.fict,
		imageArry);
		...
		dataList.setOnItemClickListener(new OnItemClickListener() {
           ...
           /*added*/ 	
                ...
                Intent i1= new Intent(Fict_Activity.this,Selected_item.class);
                i1.putExtra("title", s);
                i1.putExtra("tablename", "fiction");
                i1.putExtra("dbname", "fiction.db");
