...
public class Religion_Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.religion_activity);
		
		DataBaseHandlerReligion db = new DataBaseHandlerReligion();
	...
	//	 db.addContact(new Contact("IslamAShortHistory", imageInByte,"Karen Armstrong","1"));
		...
		adapter = new ContactImageAdapter(this, R.layout.religion,
		imageArry);
		...
		dataList.setOnItemClickListener(new OnItemClickListener() {
           ...
           /*added*/ 	
                ...
                Intent i1= new Intent(Religion_Activity.this,Selected_item.class);
                i1.putExtra("title", s);
                i1.putExtra("tablename", "religion");
                i1.putExtra("dbname", "religion.db");
