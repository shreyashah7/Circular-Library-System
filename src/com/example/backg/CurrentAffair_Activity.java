...
public class CurrentAffair_Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.currentaffair_activity);
		
		DataBaseHandlerca db = new DataBaseHandlerca();
		...
		* */
		...
		//db.addContact(new Contact("IndiaTheSeigeWithin", imageInByte,"M J akbar","1"));
		...
		adapter = new ContactImageAdapter(this, R.layout.currentaffair,
		imageArry);
		...
		dataList.setOnItemClickListener(new OnItemClickListener() {
           ...
           /*added*/ 	
                ...
                Intent i1= new Intent(CurrentAffair_Activity.this,Selected_item.class);
                i1.putExtra("title", s);
                i1.putExtra("tablename", "current");
                i1.putExtra("dbname", "current.db");
