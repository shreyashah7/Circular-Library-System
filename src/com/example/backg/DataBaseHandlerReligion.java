...
public class DataBaseHandlerReligion 
{
...
// Database Name
private static final String DATABASE_NAME = "religion.db";

// Contacts table name
private static final String TABLE_CONTACTS = "religion";
...
public DataBaseHandlerReligion() {
...
String selectQuery = "SELECT * FROM religion";
