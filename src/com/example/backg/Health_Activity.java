...
public class Health_Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		DataBaseHandlerHealth db = new DataBaseHandlerHealth();
		...
		* */
		...
		// db.addContact(new Contact("TheMakersDiet", imageInByte,"Jordan S Rubin","1"));
		...
		adapter = new ContactImageAdapter(this, R.layout.health,
		imageArry);
		...
		dataList.setOnItemClickListener(new OnItemClickListener() {
           ...
           /*added*/ 	
                ...
                Intent i1= new Intent(Health_Activity.this,Selected_item.class);
                i1.putExtra("title", s);
                i1.putExtra("tablename", "health");
                i1.putExtra("dbname", "tbllibraryhealth.db");
